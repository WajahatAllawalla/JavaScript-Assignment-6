...
//     document.write(`${cap} Fonds`)
// }




// var cars =['Alto','Mehran','Civi','Fx','Bmw']
// var userInp = prompt('Please Enter a Car name')
// var  match='no'
// var firstAlpha = userInp.slice(0,1).toUpperCase()
// var baqiAlpha = userInp.slice(1).toLowerCase()
// var final = firstAlpha+baqiAlpha
// var indr = cars.indexOf(final) 

// for(var i=0 ; i<cars.length ; i++ ){
//     if(final === cars[i] ) {
//         match="yes"
//     document.write(final+ " is available in our store")
//     document.write( `<br>this is a index of ${final} is ${indr}`) 
    
//         break
//     }
// }if(match==='no'){
//     document.write(final + 'is not available  in our Store')
// }
        


// var age=prompt(  "please enter your age");
// var startage= new Date(prompt).getTime();
// var endAge=new Date().getTime();   
// var Diff_Time = new Date(endAge - startage );
// goldenYears = Diff_Time / (1000*60*60*24*365);
// document.write("<br>"+"Your are "+goldenYears+" Years old Golden Yearer");
